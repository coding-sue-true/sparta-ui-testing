...
sleep 3
rspec_practice.set_phone_number_field(7840873640)
sleep 3
...
sleep 3
rspec_practice.set_password_field('abcde')
sleep 3
rspec_practice.set_confirmation_password_field(set_password_field)
sleep 3
